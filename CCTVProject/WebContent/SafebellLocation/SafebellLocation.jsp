				...
				<div class = "contents_area">
					...
					<div class = "content_area">
						<div class = "search_area">
							<form action="<%=request.getContextPath() %>/SafebellLocation/SafebellLocation_Result.jsp" method="POST" name = "dataSetForm" id = "dataSetForm">
								<div class = "search_part_area">
									...
									<select title="선택" name = "sk" id = "selectNm" class = "content_search_selected" style="margin: 3px 0 0 105px; width:190px; height: 40px">
										<option value = "installpurpose">설치목적구분</option>
										<option value = "adminname">관리기관명</option>
