...
<div id = "wrap">
	<header class = "upside_bar">
		...
		<div class = "inform">
			<span class = "inform_txt">4조&emsp; :&emsp;-20171195 여정한&emsp;-20171237 이준원&emsp;-20180613 임채현</span>
		</div>
		<ul class = "util">
			<li class = "btn_a"><a href = "/CCTVProject/main/index.jsp" class = "on">홈</a></li>
			<li class = "btn_a"><a href = "">정보광장</a></li>
			<li class = "btn_a"><a href = "/login/login.jsp?from=/index.jsp">로그인</a></li>
